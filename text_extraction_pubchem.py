...
# Read the Excel file
df = pd.read_excel(r"F:/NISER internship/Text-minning/pubchem_id_description/7179_metabolites/New folder/Metabolites_with_pubchem_ID_processed.xlsx")
...
pubchem_api_key = '62815109555cb6e1c776695ca04e03cae608'
...
for i in range(0, len(compound_ids), batch_size):
    ...
    if (i + batch_size) % 100 == 0:
        print("Processed {} compounds".format(i + batch_size))
